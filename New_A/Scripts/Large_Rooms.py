...
# Generate lengths, widths, and heights from 160 to 240 in increments of 2.5
lengths = np.arange(160, 242.5, 2.5)  # Lengths from 160 to 240
widths = np.arange(160, 242.5, 2.5)   # Widths from 160 to 240
heights = np.arange(160, 242.5, 2.5)  # Heights from 160 to 240
