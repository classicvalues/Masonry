...
# Generate lengths, widths, and heights from 0.5 to 150 in increments of 0.5
lengths = np.arange(0.5, 150.5, 0.5)  # Lengths from 0.5 to 150
widths = np.arange(0.5, 150.5, 0.5)   # Widths from 0.5 to 150
heights = np.arange(0.5, 150.5, 0.5)  # Heights from 0.5 to 150
