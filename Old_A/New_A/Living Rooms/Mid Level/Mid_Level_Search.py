...
output_directory = r"C:\Masonry\New_A\Living Rooms\Mid Level"  # Updated path
...
# Combine conditions for attachment containing both 'T' and 'D', ensuring neither is without the other
attachment_condition = (
    df['Attachment'].str.contains('T', na=False) &
    df['Attachment'].str.contains('D', na=False) &
    ~df['Attachment'].str.contains('T') & df['Attachment'].str.contains('D')
)
