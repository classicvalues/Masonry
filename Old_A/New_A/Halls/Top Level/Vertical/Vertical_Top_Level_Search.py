...
output_directory = r"C:\Masonry\New_A\Halls\Top Level\Vertical"  # Updated output path
...
# Filter conditions
length_condition = (df['Length'] >= 72) & (df['Length'] <= 576) & ((df['Length'] - 72) % 12 == 0)
width_condition = (df['Width'] >= 36) & (df['Width'] <= 72) & ((df['Width'] - 36) % 12 == 0)
...
# Combine conditions for attachment containing 'D' but not 'T' (case-sensitive)
