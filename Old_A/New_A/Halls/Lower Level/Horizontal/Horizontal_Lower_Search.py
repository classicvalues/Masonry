...
output_directory = r"C:\Masonry\New_A\Halls\Lower Level\Horizontal"  # Updated output path
...
# Combine conditions for attachment containing 'T' but not 'D' (case-sensitive)
