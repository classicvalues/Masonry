...
# Generate lengths, widths, and heights from 40 to 160 in increments of 2.5
lengths = np.arange(40, 162.5, 2.5)  # Lengths from 40 to 160
widths = np.arange(40, 162.5, 2.5)   # Widths from 40 to 160
heights = np.arange(40, 162.5, 2.5)  # Heights from 40 to 160
