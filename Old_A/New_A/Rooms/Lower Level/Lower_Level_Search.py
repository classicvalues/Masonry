...
output_directory = r"C:\Masonry\New_A\Rooms\Lower Level"  # Updated path
...
# Combine conditions for attachment containing 'T' but not 'D'
attachment_condition = df['Attachment'].str.contains('T', na=False) & ~df['Attachment'].str.contains('D', na=False)
